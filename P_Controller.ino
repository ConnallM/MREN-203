/*
 * Connall Milberry
 * P Controller for LynxMotion rover
 */
...
// Overall vehicle translational speed, positive forward, negative backwards
double V = 0;

// Desired Velocity
double dV = 1;

// Overall vehicle turning rate, positive cw, negative ccw
double omega = 0;
...
void loop()
{
    ...
    uL = P_controller (dV - V_L, 150);
    uR = P_controller (dV - V_R, 150);
